...
router.post(
    ...
    [
        ...
        check("especialidad").isArray().withMessage("Las habilidades deben ser un array"),
    ...
    async (req, res) => {
        ...
        try {
            ...
            const newFreelancer = { nombre, email, especialidad, telefono };
            await freelancerService.addFreelancer(newFreelancer);
